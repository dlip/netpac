...
public:	
	int CallBack_LoadTexture(char* sTextureReference, char* sTextureName, int* iTextureIndex, cCONST_TV_COLORKEY* eColorKey);
	int CallBack_LoadShader(char* sShaderReference, char* sShaderName);

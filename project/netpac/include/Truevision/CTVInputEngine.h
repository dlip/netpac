...
public:
	...
	void GetMouseState(int* retX, int* retY, bool* retButton1 = NULL, bool* retButton2 = NULL, bool* retButton3 = NULL, bool* retButton4 = NULL, int* retRoll = NULL);
	void GetAbsMouseState(int* retX, int* retY, bool* retButton1= NULL, bool* retButton2= NULL, bool* retButton3= NULL, bool* retButton4= NULL, int* retRoll = NULL);
